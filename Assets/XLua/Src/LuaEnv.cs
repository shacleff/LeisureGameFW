...
namespace XLua
{
    ...
    public class LuaEnv : IDisposable
    {
        ...
        /// 执行一个代码块
        /// </summary>
        /// <param name="chunk">代码文字串</param>
        /// <param name="chunkName">发送error时的debug显示信息中使用，指明某某代码块的某行错误</param>
        /// <param name="env">这个代码块的环境变量</param>
        /// <returns>return 1,"hello"，DoString返回将包含两个object的数组，一个是double类型的1，一个是string类型的"hello"</returns>
